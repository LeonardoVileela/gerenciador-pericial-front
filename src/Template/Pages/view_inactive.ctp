...
<div class="col-xs-12">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">Usuários Inativos</h3>
    </div>
    <!-- /.box-header -->
            ...
            <?php foreach ($user as $u) { ?>
              ...
              <?php if ($this->Session->read('Auth.User.role_id') == 2) { ?>
                <td>
                  ...
                  <a onclick='promoteUser()' id='promote-user' class='text-green icon-size-medium mouse-pointer' title='Ativar usuário' data-toggle='modal' data-id='<?= $u->id ?>' data-name='<?= $u->name ?>' data-target='#modal-promote'>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Ativar usuário</h3>
      </div>
...
<script>
  function promoteUser() {
    ...
    var textName = 'Tem certeza que deseja Ativar esse usuário ' + name + '?'
  ...
  function removeUser() {
    ...
    var textName = 'Tem certeza que deseja remover o usuario ' + name + ' do sistema ?'
